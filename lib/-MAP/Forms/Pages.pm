...
our $VERSION = '0.1';
our $collectionName = 'pages';
our $primaryKey = 'page_id';
our $tableName = 'FORMMAKER_Pages';
our $defaultColumns = 'page_id,form_id,pagename,index,key_id,page_layout,tab_width';

our $relationalColumn = 'form_id'; # undef
